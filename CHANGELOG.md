...
* 数据质量标记（P7）：新增 `packages/data_sources/quality.py`，quote/trend/history/filings/news/macro/Tiger 数据响应统一附加 `data_quality`（source/as_of/freshness/missing_fields/fallback），前端报价区展示 source/freshness
